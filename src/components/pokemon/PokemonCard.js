      ...
      <div className="col-md-3 col-sm-6 mb-5">
        <StyledLink to={`../pokemon/${this.state.pokemonIndex}`}>
          <Card className="card">
            ...
            <h5 className="card-header text-center">{this.state.pokemonIndex.length == 1 ? '00'+(this.state.pokemonIndex) :
                                                      this.state.pokemonIndex.length == 2 ? '0'+(this.state.pokemonIndex) : (this.state.pokemonIndex)}</h5>
